		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ABP- Spot It",
									"targetURL": "#comabpspotit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comabpspotit-display": {
								"semanticObject": "comabpspotit",
								"action": "display",
								"description": "ABP- Spot It",
								"title": "ABP- Spot It",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.abp.spotit",
									"url": sap.ui.require.toUrl("com/abp/spotit")
								}
							}
						}
					}
